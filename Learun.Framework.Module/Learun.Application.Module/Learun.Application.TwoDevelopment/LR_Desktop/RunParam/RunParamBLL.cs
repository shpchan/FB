...
namespace Learun.Application.TwoDevelopment.LR_Desktop
{
    ...
    /// 描 述：设备运行参数
    /// </summary>
    public class RunParamBLL : RunParamIBLL
    {
        private RunParamService runParamService = new RunParamService();
        ...
        public IEnumerable<tb_run_infoEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return runParamService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public tb_machine_infoEntity Gettb_machine_infoEntity(string keyValue)
        {
            try
            {
                return runParamService.Gettb_machine_infoEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public tb_run_infoEntity Gettb_run_infoEntity(string keyValue)
        {
            try
            {
                return runParamService.Gettb_run_infoEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                runParamService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, tb_run_infoEntity entity,tb_machine_infoEntity tb_machine_infoEntity)
        {
            try
            {
                runParamService.SaveEntity(keyValue, entity,tb_machine_infoEntity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
