...
namespace Learun.Application.TwoDevelopment.LR_LGManager
{
    ...
    /// 描 述：tool_model
    /// </summary>
    public class ToolModelBLL : ToolModelIBLL
    {
        private ToolModelService toolModelService = new ToolModelService();
        ...
        public IEnumerable<tb_toolmodel_infoEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return toolModelService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public tb_toolmodel_infoEntity Gettb_toolmodel_infoEntity(string keyValue)
        {
            try
            {
                return toolModelService.Gettb_toolmodel_infoEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public tb_tooltype_infoEntity Gettb_tooltype_infoEntity(string keyValue)
        {
            try
            {
                return toolModelService.Gettb_tooltype_infoEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                toolModelService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, tb_tooltype_infoEntity entity,tb_toolmodel_infoEntity tb_toolmodel_infoEntity)
        {
            try
            {
                toolModelService.SaveEntity(keyValue, entity,tb_toolmodel_infoEntity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
