...
namespace Learun.Application.TwoDevelopment.LR_LGManager
{
    ...
    public class ProductEcodeBLL : ProductEcodeIBLL
    {
        ...
        public IEnumerable<tb_product_hisEntity> GetPageListOriginal(Pagination pagination, string queryJson)
        {
            try
            {
                return productEcodeService.GetPageListOriginal(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<tb_product_hisEntity> GetPageListOne(Pagination pagination, string queryJson)
        {
            try
            {
                return productEcodeService.GetPageListOne(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<tb_product_hisEntity> GetListOnce(string product_ecode, string StartTime, string EndTime)
        {
            try
            {
                return productEcodeService.GetListOnce(product_ecode, StartTime, EndTime);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
