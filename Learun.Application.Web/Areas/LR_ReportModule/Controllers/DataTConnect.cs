...
{
    public class DataTConnect
    {
        log4net.ILog log = log4net.LogManager.GetLogger("DataTConnect");
        ...
        protected bool _initDBTConnect()
        {
        ...
        //数据库读取
        public DataTable getStrSqlTData(string logMsg, string strSql)
        {
            ds.Clear();
            dtInfo.Clear();
        ...
        //数据库写入
        protected bool putStrSqlTData(string logMsg, string strSql)
        {
        ...
        //数据库更新
        protected bool updateStrSqlTData(string logMsg, string strSql)
        {
            sqlcom = sqltconn.CreateCommand();
            sqlcom.CommandType = CommandType.Text;
            sqlcom.CommandText = strSql;
