...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            /*检测重复项*/
            $('#open_id').on('blur', function () {
                $.lrExistField(keyValue, 'open_id', top.$.rootUrl + '/LR_LGManager/stock_info/ExistOpen_id');
            });
        },
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/LR_LGManager/stock_info/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    setFormData = function (processId) {
        if (!!processId) {
            $.lrSetForm(top.$.rootUrl + '/LR_LGManager/stock_info/GetFormData?keyValue=' + processId, function (data) {//
                //if (!!data) {
                //    isUpdate = true;
    ...
    acceptClick = function (callBack) {
        ...
        $.lrSaveForm(top.$.rootUrl + '/LR_LGManager/stock_info/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
