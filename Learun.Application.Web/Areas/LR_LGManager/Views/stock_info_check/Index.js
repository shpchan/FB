    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
               learun.layerForm({
                    id: 'form',
                    title: '新增',
                   url: top.$.rootUrl + '/LR_LGManager/stock_info_check/Form',
                    width: 600,
                    height: 400,
            ...
            $('#lr_edit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '编辑',
                        url: top.$.rootUrl + '/LR_LGManager/stock_info_check/Form?keyValue=' + keyValue,
                        width: 600,
                        height: 400,
                        //callBack: function (id) {
            ...
            $('#lr_read').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm_Read({
                        id: 'form',
                        title: '查看详情',
                        url: top.$.rootUrl + '/LR_LGManager/stock_info_edit/Form?keyValue=' + keyValue,
                        width: 600,
                        height: 400,
                        //callBack: function (id) {
                        //    return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_submit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否提交审核该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/LR_LGManager/stock_info_check/SubmitForm', { keyValue: keyValue }, function () {
                                refreshGirdData1();
                            });
                        }
                    });
            ...
            $('#lr_agree').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否通过审核该项！', function (res) {
                        if (res) {
                            learun.postForm(top.$.rootUrl + '/LR_LGManager/stock_info_check/AgreeForm', { keyValue: keyValue }, function () {
                                refreshGirdData1();
                            });
                        }
                    });
            ...
            $('#lr_disagree').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否驳回审核该项！', function (res) {
                        if (res) {
                            learun.postForm(top.$.rootUrl + '/LR_LGManager/stock_info_check/DisAgreeForm', { keyValue: keyValue }, function () {
                                refreshGirdData1();
                            });
                        }
                    });
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                   learun.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/LR_LGManager/stock_info_check/DeleteForm', { keyValue: keyValue}, function () {
                                refreshGirdData1();
                            });
                        }
                    });
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/LR_LGManager/stock_info_check/GetPageList',
                headData: [
                    { label: "操作", name: "oprate", width: 100, align: "left" },
