...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/LR_LGManager/stock_info_check/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    setFormData = function (processId) {
        if (!!processId) {
            $.lrSetForm(top.$.rootUrl + '/LR_LGManager/stock_info_check/GetFormData?keyValue=' + processId, function (data) {//
                //if (!!data) {
                //    isUpdate = true;
    ...
    acceptClick = function (callBack) {
        ...
        $.lrSaveForm(top.$.rootUrl + '/LR_LGManager/stock_info_check/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
