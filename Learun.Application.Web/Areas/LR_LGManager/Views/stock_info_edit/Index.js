    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
               learun.layerForm({
                    id: 'form',
                    title: '新增',
                   url: top.$.rootUrl + '/LR_LGManager/stock_info_edit/Form',
                    width: 600,
                    height: 400,
            ...
            $('#lr_submit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否提交审核该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/LR_LGManager/stock_info_edit/SubmitForm', { keyValue: keyValue }, function () {
                                refreshGirdData1();
                            });
                        }
                    });
            ...
            $('#lr_calc').on('click', function () {
                    learun.layerConfirm('是否手动刷新即时库存？', function (res) {
                        if (res) {
                            learun.postForm(top.$.rootUrl + '/LR_LGManager/stock_info_edit/Recalculator', function () {
                                refreshGirdData1();
                            });
                        }
                    });
            ...
            $('#lr_agree').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否通过审核该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/LR_LGManager/stock_info_edit/AgreeForm', { keyValue: keyValue }, function () {
                                refreshGirdData1();
                            });
                        }
                    });
            ...
            $('#lr_disagree').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否驳回审核该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/LR_LGManager/stock_info_edit/DisAgreeForm', { keyValue: keyValue }, function () {
                                refreshGirdData1();
                            });
                        }
                    });
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                   learun.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/LR_LGManager/stock_info_edit/DeleteForm', { keyValue: keyValue}, function () {
                                refreshGirdData1();
                            });
                        }
                    });
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/LR_LGManager/stock_info_edit/GetPageList',
                headData: [
