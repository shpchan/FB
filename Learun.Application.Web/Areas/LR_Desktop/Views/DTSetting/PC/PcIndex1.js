...
var bootstrap = function (a, d) {
    ...
    var f = {
        init: function () {
            ...
            d.httpAsync("GET", top.$.rootUrl + "/LR_Desktop/DTChart/GetPageList1", {},
                function (h) {
                    f.chart(h || [])
                })
        },
        ...
        chart: function (i) {
            ...
            a.each(i,
                function (k, l) {
                    ...
                    top.learun.httpAsync("GET", top.$.rootUrl + "/LR_Desktop/DTChart/GetSqlData1", {
                        Id: l.F_Id
                    },
                        function (m) {
                            if (m) {
                ...
                function () {
                    ...
                    if (k === "编辑") {
                        ...
                        d.layerConfirm("是否确认删除该项！",
                            function (l) {
                                if (l) {
                                    d.deleteForm(top.$.rootUrl + "/LR_Desktop/DTChart/DeleteForm1", {
                                        keyValue: j.F_Id
                                    },
                                        function () {
                                            refreshGirdData()
