...
namespace Learun.Application.Web.Areas.LR_Desktop.Controllers
{
    ...
    /// 描 述：设备运行参数
    /// </summary>
    public class RunParamController : MvcControllerBase
    {
        private RunParamIBLL runParamIBLL = new RunParamBLL();
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = runParamIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var tb_run_infoData = runParamIBLL.Gettb_run_infoEntity( keyValue );
            var tb_machine_infoData = runParamIBLL.Gettb_machine_infoEntity( tb_run_infoData.id );
            var jsonData = new {
        ...
        {
            runParamIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
        ...
        public ActionResult SaveForm(string keyValue, string strEntity, string strtb_machine_infoEntity)
        {
            ...
            runParamIBLL.SaveEntity(keyValue,entity,tb_machine_infoEntity);
            return Success("保存成功！");
        }
        #endregion
