...
var bootstrap = function ($, learun) {
    ...
    var mergeFileChunks = function (file) {
        ...
        if (id == "7c4ceb22-0c23-449c-895a-ecb860cb24c0") {//安全库存bom表导入
                if (window.confirm('是否导入前对已有数据清空并备份？')) {
                    learun.httpAsyncPost(top.$.rootUrl + "/LR_SystemModule/ExcelImport/ExecuteImportExcel_bak", param, function (res) {
