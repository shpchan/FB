            ...
            $('#lr_frame_menu .lr-menu-item').on('click', function () {
                ...
                switch (_module.F_Target) {
                    ...
                    case 'open':// 窗口
                        if (learun.validator.isNotNull(_module.F_UrlAddress).code) {
                            //learun.frameTab.open(_module);
                            //window.open(_module.F_UrlAddress, '_self', 'width=600,height=400,top=100px,left=0px');
                             window.open(_module.F_UrlAddress);
                            //window.open(_module.F_UrlAddress, '', 'left = 0, top = 0, width = '+ (screen.availWidth - 10) +', height = '+ (screen.availHeight-50) +', scrollbars, resizable = yes, toolbar = no');
                        }
                        else {
